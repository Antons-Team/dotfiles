...
--BIG block of code copied from distrotube
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "s", function() awful.util.spawn("systemctl hibernate") end,
    ...
    awful.key({ modkey },            "c",     function () awful.util.spawn(editor_cmd .. " " .. awesome.conffile) end, 
              {description = "config", group = "awesome"}),
...
--
-- autostart
awful.spawn.with_shell("~/.config/feh/.fehbg")
